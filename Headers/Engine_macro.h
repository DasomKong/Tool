...
{if( _ptr == 0){MessageBoxW(NULL, _message, L"System Message",MB_OK);__asm { int 3 };}}

#define NULL_CHECK_RETURN_MSG( _ptr, _return, _message )	\
{if( _ptr == 0){MessageBoxW(NULL, _message, L"System Message",MB_OK);__asm { int 3 };return _return;}}
